...
function AdminDashboard(){
 ...
 return <section className="container-page py-10">
  <div className="flex flex-wrap items-center justify-between gap-4">
   <div><p className="font-semibold text-disco-yellow">Admin general</p><h1 className="text-4xl font-black">Centro de control</h1><p className="mt-2 max-w-3xl text-white/70">Roles, seguridad, productores, RRPP, links propios, cargos de servicio, acreditación y reportes operativos en una sola consola.</p></div>
   <div className="flex flex-wrap gap-2"><Link href="/admin/eventos/nuevo" className="btn-primary">Crear evento</Link><Link href="/admin/usuarios" className="btn-secondary">Crear usuario</Link></div>
  </div>
  ...
  <div className="mt-8 grid gap-6 lg:grid-cols-2">
   ...
   <div className="card p-6"><h2 className="text-xl font-black">Seguridad operativa</h2><ul className="mt-4 space-y-3 text-sm text-white/70"><li>• Login real requerido.</li><li>• Super admin puede probar todo.</li><li>• Cada rol habilita sus funciones.</li><li>• Acreditación limitada por evento y función.</li><li>• Cargos de servicio configurables desde admin general.</li></ul></div>
  </div>
 </section>
}
