  ...
  return <section className="container-page py-10">
    <div className="flex flex-wrap items-end justify-between gap-4">
      ...
      <div className="flex flex-wrap gap-2">
        <button onClick={() => addTicket('courtesy')} className="btn-secondary"><Gift size={18} className="mr-2"/>Agregar cortesía</button>
        <button onClick={() => addTicket('sale')} className="btn-primary"><Plus size={18} className="mr-2"/>Agregar ticket</button>
      </div>
    </div>
    ...
    <div className="mt-8 grid gap-4 md:grid-cols-5">
      ...
      <div className="card p-5"><p className="text-sm text-white/55">Cortesías</p><p className="mt-2 text-3xl font-black text-white">{courtesyTickets}</p></div>
    </div>
