...
export default async function EventDetailPage({ params, searchParams }: PageProps) {
  ...
  if (eventQuery.error) return <ErrorBox message={eventQuery.error.message} />;
  if (!eventQuery.data) return <ErrorBox message="El evento no existe o todavía no está publicado." />;
  ...
  const event = mapEvent(eventRow, dates ?? [], sectors ?? [], ticketTypes ?? []);
